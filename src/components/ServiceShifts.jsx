...
const ServiceShifts = (backendUrl, legajo, usuarioNombre) => {
  ...
  useEffect(() => {
    if (diaActual) {
      // Decodificar el día y quitar tildes
      const diaDecodificado = decodeURIComponent(diaActual);
      const diaSinTilde = diaDecodificado.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
      console.log("Día actual calculado en useEffect y sacandole la tilde:", diaSinTilde); // Verificación del día calculado sin tilde
